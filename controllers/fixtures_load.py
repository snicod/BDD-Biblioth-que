...
CREATE TABLE emprunt (
    ...
    oeuvres = [{'id': 1, 'titre': 'le retour de Poirot', 'date_parution': datetime.date(1960, 2, 12),
               ...
               {'id': 13, 'titre': 'petits poèmes en prose', 'date_parution': datetime.date(1969, 1, 1), 'photo': '15',
                'auteur_id': None},
    ...
    exemplaires = [
        {'id': 1, 'etat': 'BON', 'date_achat': datetime.date(2021, 8, 25), 'prix': Decimal('13.50'), 'oeuvre_id': 1},
        ...
        {'id': 5, 'etat': 'MAUVAIS', 'date_achat': datetime.date(2020, 10, 29), 'prix': Decimal('13.00'),
         'oeuvre_id': 2},
        ...
        {'id': 15, 'etat': 'MAUVAIS', 'date_achat': datetime.date(2021, 1, 26), 'prix': Decimal('28.00'),
         'oeuvre_id': 7},
        ...
        {'id': 24, 'etat': 'MAUVAIS', 'date_achat': datetime.date(2021, 1, 24), 'prix': Decimal('22.00'),
         'oeuvre_id': 13},
        {'id': 25, 'etat': 'BON', 'date_achat': datetime.date(2015, 1, 28), 'prix': Decimal('22.00'), 'oeuvre_id': 13},
        {'id': 26, 'etat': 'MAUVAIS', 'date_achat': datetime.date(2021, 1, 23), 'prix': Decimal('26.00'),
         'oeuvre_id': 14},
        ...
        {'id': 30, 'etat': 'MAUVAIS', 'date_achat': datetime.date(2021, 1, 26), 'prix': Decimal('32.00'),
         'oeuvre_id': 16},
        ...
        {'id': 35, 'etat': 'MAUVAIS', 'date_achat': datetime.date(2020, 10, 29), 'prix': Decimal('15.00'),
         'oeuvre_id': 19},
        {'id': 36, 'etat': 'NEUF', 'date_achat': datetime.date(2021, 10, 29), 'prix': Decimal('18.00'),
         'oeuvre_id': 19},
        {'id': 37, 'etat': 'BON', 'date_achat': datetime.date(2021, 1, 23), 'prix': Decimal('8.00'), 'oeuvre_id': 19},
        {'id': 38, 'etat': 'MAUVAIS', 'date_achat': datetime.date(2020, 9, 28), 'prix': Decimal('18.00'),
         'oeuvre_id': 20},
    ...
    emprunts = [{'adherent_id': 6, 'exemplaire_id': 2, 'date_emprunt': datetime.date(2021, 9, 21),
                 'date_retour': datetime.date(2021, 9, 28)},
                {'adherent_id': 7, 'exemplaire_id': 2, 'date_emprunt': datetime.date(2021, 10, 21),
                 'date_retour': datetime.date(2021, 10, 28)},
                {'adherent_id': 8, 'exemplaire_id': 2, 'date_emprunt': datetime.date(2021, 11, 21),
                 'date_retour': datetime.date(2021, 11, 28)},
                ...
                {'adherent_id': 2, 'exemplaire_id': 5, 'date_emprunt': datetime.date(2021, 8, 23),
                 'date_retour': datetime.date(2021, 9, 23)},
                {'adherent_id': 2, 'exemplaire_id': 5, 'date_emprunt': datetime.date(2021, 12, 15),
                 'date_retour': None},
                {'adherent_id': 3, 'exemplaire_id': 5, 'date_emprunt': datetime.date(2021, 7, 26),
                 'date_retour': datetime.date(2021, 8, 23)},
                {'adherent_id': 3, 'exemplaire_id': 5, 'date_emprunt': datetime.date(2021, 11, 23),
                 'date_retour': datetime.date(2021, 12, 24)},
                {'adherent_id': 4, 'exemplaire_id': 6, 'date_emprunt': datetime.date(2022, 1, 22),
                 'date_retour': datetime.date(2022, 1, 23)},
                {'adherent_id': 4, 'exemplaire_id': 6, 'date_emprunt': datetime.date(2022, 1, 25), 'date_retour': None},
                {'adherent_id': 3, 'exemplaire_id': 7, 'date_emprunt': datetime.date(2022, 2, 22),
                 'date_retour': datetime.date(2022, 3, 29)},
                {'adherent_id': 2, 'exemplaire_id': 8, 'date_emprunt': datetime.date(2021, 12, 30),
                 'date_retour': None},
                {'adherent_id': 3, 'exemplaire_id': 9, 'date_emprunt': datetime.date(2022, 1, 25), 'date_retour': None},
                {'adherent_id': 8, 'exemplaire_id': 9, 'date_emprunt': datetime.date(2021, 7, 26),
                 'date_retour': datetime.date(2021, 9, 22)},
                {'adherent_id': 3, 'exemplaire_id': 11, 'date_emprunt': datetime.date(2022, 1, 26),
                 'date_retour': datetime.date(2022, 2, 21)},
                {'adherent_id': 3, 'exemplaire_id': 13, 'date_emprunt': datetime.date(2022, 1, 4), 'date_retour': None},
                {'adherent_id': 6, 'exemplaire_id': 15, 'date_emprunt': datetime.date(2021, 9, 23),
                 'date_retour': datetime.date(2021, 9, 26)},
                {'adherent_id': 2, 'exemplaire_id': 18, 'date_emprunt': datetime.date(2021, 9, 23),
                 'date_retour': datetime.date(2021, 10, 28)},
                {'adherent_id': 2, 'exemplaire_id': 19, 'date_emprunt': datetime.date(2022, 2, 26),
                 'date_retour': None},
                {'adherent_id': 4, 'exemplaire_id': 19, 'date_emprunt': datetime.date(2021, 9, 21),
                 'date_retour': None},
                {'adherent_id': 4, 'exemplaire_id': 27, 'date_emprunt': datetime.date(2022, 2, 22),
                 'date_retour': None},
                {'adherent_id': 3, 'exemplaire_id': 33, 'date_emprunt': datetime.date(2022, 1, 30),
                 'date_retour': None},
                {'adherent_id': 4, 'exemplaire_id': 34, 'date_emprunt': datetime.date(2022, 1, 23),
                 'date_retour': datetime.date(2022, 2, 20)},
                {'adherent_id': 2, 'exemplaire_id': 35, 'date_emprunt': datetime.date(2021, 7, 13),
                 'date_retour': datetime.date(2021, 9, 21)},
                {'adherent_id': 2, 'exemplaire_id': 37, 'date_emprunt': datetime.date(2022, 2, 11),
                 'date_retour': None},
                {'adherent_id': 7, 'exemplaire_id': 38, 'date_emprunt': datetime.date(2021, 7, 26),
                 'date_retour': datetime.date(2021, 10, 22)},
                {'adherent_id': 2, 'exemplaire_id': 40, 'date_emprunt': datetime.date(2022, 1, 23),
                 'date_retour': datetime.date(2022, 2, 23)},
                {'adherent_id': 3, 'exemplaire_id': 40, 'date_emprunt': datetime.date(2021, 11, 23),
                 'date_retour': datetime.date(2021, 12, 24)},
                {'adherent_id': 5, 'exemplaire_id': 40, 'date_emprunt': datetime.date(2021, 7, 25),
                 'date_retour': datetime.date(2021, 9, 22)},
                {'adherent_id': 9, 'exemplaire_id': 15, 'date_emprunt': datetime.date(2022, 2, 22),
                 'date_retour': None},
                {'adherent_id': 9, 'exemplaire_id': 18, 'date_emprunt': datetime.date(2022, 1, 30),
                 'date_retour': None}
                ]
